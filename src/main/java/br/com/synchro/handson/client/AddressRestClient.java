...
public class AddressRestClient {
    ...
    private static final String REST_API_LOAD_ALL = "http://localhost:5050/hands-on-services/resource/handson-service/get-all";
    private static final String REST_API_ADD = "http://localhost:5050/hands-on-services/resource/handson-service/post";
